...
/**
 * Plugin Name:         Search Support For WPML with Algolia
 * Description:         Filter your posts and pages by language
...
function swa_algolia_default_template($locations, $file)
{
    ...
    return SWA_PLUGIN_DIR . 'templates/' . $file;
}
